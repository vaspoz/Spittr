...
import edu.vaspoz.spittr.controller.SpittleController;
...
public class SpittleControllerTest {
    ...
    public void testShowSpittle() throws Exception {
        ...
        Spittle expectedSpittle = new Spittle("Hello, I`m a test spittle", new Date());
        SpittleRepository mockRepository = mock(SpittleRepository.class);
    ...
    @Test
    public void testShowSpittleDirect() throws Exception {

        Spittle expectedSpittle = new Spittle("Hello, I`m another test spittle", new Date());
        SpittleRepository mockRepository = mock(SpittleRepository.class);
        when(mockRepository.findOne(12345))
                .thenReturn(expectedSpittle);
